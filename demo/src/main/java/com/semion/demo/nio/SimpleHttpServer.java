...
public class SimpleHttpServer {
	...
	private static void execute(ServerSocketChannel serverSocketChannel) throws IOException {
		...
		try {
			...
			MyRequestObject myRequestObject = null;//receiveData(socketChannel);
	...
	private static SimpleHttpRequest receiveData(SocketChannel socketChannel) throws IOException {
